...
if (isset($_SESSION['stud_id'])) {
    ...
    $q = $con->prepare("select * from tbl_studentdata where stud_id=?");
    $param = "active";
    $q->bind_param("s", $_SESSION['stud_id']);
    $q->execute();
    $k = $q->get_result();
    $data = $k->fetch_assoc();
} else {
    ...
    <body class="">
        ...
        <div class="wrapper">
            <div class="sidebar" data-image="assets/img/full-screen-image-3.jpg">
                ...
                <div class="logo">
                    <a  class="simple-text logo-mini" href="companycard.php">
                ...
                <div class="sidebar-wrapper">
                    <div class="user">
                        <div class="info">
                            <div class="photo">
                                <img src="../images/Student_Images/<?php echo $data['stud_image']; ?>" />
                            </div>
                            ...
                            <div class="collapse" id="collapseExample">
                                <ul class="nav">
                                    ...
                                    <li>
                                        <a href="studenteditprofile.php" id="editprofile">
                    ...
                    <ul class="nav">
                        ...
                        <li>
                            <a href="placements.php">
                                ...
                                <p class="pink_col">Placements Details</p>
                            </a>
