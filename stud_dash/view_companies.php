    ...
    <body>
        ...
        <div class="">
            <div class="text-center">
                    <div class="">
                        <h3 class="dpink_col"><i class="fa fa-building gray_col"></i>&nbsp;&nbsp; View Companies</h3>
                    </div>
                </div>
            <div class="col-sm-12">
                <?php
                if ($con) {
                    ...
                    if ($k = $r->fetch_array()) {
                        ...
                        echo '<center><h5 class="text-danger"><i class="fa fa-dropbox gray_col" style="font-size:30px"></i><br><br> NO COMPANIES.</h5></center>';
                    }
                }
                ?>
            </div>
