...
<html ng-app="myApp" ng-controller="AppCtrl" lang="en">
    <head>
        ...
        <link href="calendar_assets/css/style.css" rel="stylesheet" type="text/css"/>
        <meta charset="utf-8" />
        <link rel="icon" type="image/png" href="cal_assets/img/favicon.ico">
    ...
    <script src="cal_assets/js/moment.min.js"></script>

    <!--  Checkbox, Radio, Switch and Tags Input Plugins -->
    <script src="cal_assets/js/bootstrap-switch-tags.min.js"></script>


    <!-- Sweet Alert 2 plugin -->
    <script src="cal_assets/js/sweetalert2.js"></script>

    <!--  Full Calendar Plugin    -->
    <script src="cal_assets/js/fullcalendar.min.js"></script>



    <!-- Light Bootstrap Dashboard DEMO methods, don't include it in your project! -->
    <script src="cal_assets/js/demo.js"></script>
