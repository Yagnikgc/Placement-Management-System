                    ...
                    <ul class="timeline animate-box">
                        ...
                        <li class="timeline-inverted animate-box">
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p>We Belive in creating a creator<br>Students working on <?php echo $num_of_tech['num_data']; ?>+ technologies</p>
                                </div>
                            </div>
                        </li>
                        <li class="animate-box timeline-unverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h3 class="timeline-title"><?php echo $num_of_comp['num_data']; ?>+ companies &nbsp;<i class="dpink_col fa fa-briefcase"></i></h3>
                                </div>
                                <div class="timeline-body">
                                    <p>Having trust of more than <?php echo $num_of_comp['num_data']; ?> companies...<br>Had placements of 200+ students,under Varying Technologies</p>
                                </div>
                            </div>
                        </li>
                    </ul>
